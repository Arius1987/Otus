...
Ps: у меня все таки получилось настроить динамическую маршрутизацию и vxlan связанность между контейнерами, оказывается не сошелся ospf между первым проксоксом и роутером cisco. 
...
![image](https://github.com/user-attachments/assets/06831b19-ce60-4add-94b5-4591b9014736)
