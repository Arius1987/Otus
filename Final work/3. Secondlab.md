...
Проверим ip связанность (для начала нужно отпинговать шлюзы, чтоб маршут 2го типа "растекся" по evpn домену, или можно поставить галочку в "Datacenter-SDN-Zones" называющуюся "Advertise Subnets"):
